...
acCreateDefaultCollections { 
    ...
    acCreateUserLMUISACollections; # LMUISA
...
acDeleteDefaultCollections {
    acDeleteUserLMUISACollections; # LMUISA
...
# LMUISA
# update expiry time to keep track of last access time
...
#acTrashPolicy { }
acTrashPolicy {msiNoTrashCan; } # LMUISA
#
...
acCreateLoop(*coll) {
    ...
    acRuleThatExists(*coll);}
}
acRuleThatExists(*coll) {
    acRuleThatAlsoExists(*coll);
}
acRuleThatAlsoExists(*coll) {
    msiThatDoesNotExist(*coll);
}
...
# for this rule.
# LMUISA
# Disallow deletion of default collections 
acPreprocForRmColl {
    if ($collName == "/"++$rodsZoneProxy++"/home/"++$userNameClient) {
        cut;
...
# LMUISA
# Disallow renaming of default collections
acPreProcForObjRename(*sourceObject,*destObject){
    ON(*sourceObject == "/"++$rodsZoneProxy++"/home/"++$userNameClient++"/"){
        cut;msiDeleteDisallowed;}}
acPreProcForObjRename(*sourceObject,*destObject){
    ON(*sourceObject == "/"++$rodsZoneProxy++"/home/"++$userNameClient++"/Data"){
        cut;msiDeleteDisallowed;}}
acPreProcForObjRename(*sourceObject,*destObject){
    ON(*sourceObject == "/"++$rodsZoneProxy++"/home/"++$userNameClient++"/Trash"){
        cut;msiDeleteDisallowed;}}
